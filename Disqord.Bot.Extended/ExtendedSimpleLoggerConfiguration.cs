...
namespace Disqord.Bot.Extended
{
    ...
    {
        /// <summary>
        /// Whether or not <see cref="LogMessageSeverity.Trace"/> messages will be logged.
        /// <para>Defaults to <see langword="true"/>.</para>
        /// </summary>
        public bool EnableTraceLogSeverity { get; set; } = true;
        /// <summary>
        /// The color to set the console foreground (text) color when logging <see cref="LogMessageSeverity.Trace"/> messages.
        /// <para>Defaults to <see cref="ConsoleColor.Cyan"/>.</para>
        /// </summary>
        public ConsoleColor TraceForegroundColor { get; set; } = ConsoleColor.Cyan;
        /// <summary>
        /// The color to set the console background color when logging <see cref="LogMessageSeverity.Trace"/> messages.
        /// <para>Defaults to <see cref="DefaultBackgroundColor"/>.</para>
        /// </summary>
        public ConsoleColor TraceBackgroundColor { get; set; } = default;
        /// <summary>
        /// The text to use when logging <see cref="LogMessageSeverity.Trace"/> messages.
        /// <para>Defaults to <c>Trace</c>.</para>
        /// </summary>
        public string TraceLevelText { get; set; } = "Trace";

        /// <summary>
        /// Whether or not <see cref="LogMessageSeverity.Debug"/> messages will be logged.
        /// <para>Defaults to <see langword="true"/>.</para>
        /// </summary>
        public bool EnableDebugLogSeverity { get; set; } = true;
        /// <summary>
        /// The color to set the console foreground (text) color when logging <see cref="LogMessageSeverity.Debug"/> messages.
        ...
        /// <summary>
        /// The color to set the console background color when logging <see cref="LogMessageSeverity.Debug"/> messages.
        /// <para>Defaults to <see cref="DefaultBackgroundColor"/>.</para>
        /// </summary>
        public ConsoleColor? DebugBackgroundColor { get; set; } = default;
        /// <summary>
        /// The text to use when logging <see cref="LogMessageSeverity.Debug"/> messages.
        /// <para>Defaults to <c>Debug</c>.</para>
        /// </summary>
        public string DebugLevelText { get; set; } = "Debug";

        /// <summary>
        /// Whether or not <see cref="LogMessageSeverity.Information"/> messages will be logged.
        /// <para>Defaults to <see langword="true"/>.</para>
        /// </summary>
        public bool EnableInformationLogSeverity { get; set; } = true;
        /// <summary>
        /// The color to set the console foreground (text) color when logging <see cref="LogMessageSeverity.Information"/> messages.
        ...
        /// <summary>
        /// The color to set the console background color when logging <see cref="LogMessageSeverity.Information"/> messages.
        /// <para>Defaults to <see cref="DefaultBackgroundColor"/>.</para>
        /// </summary>
        public ConsoleColor? InformationBackgroundColor { get; set; } = default;
        /// <summary>
        /// The text to use when logging <see cref="LogMessageSeverity.Information"/> messages.
        /// <para>Defaults to <c>Information</c>.</para>
        /// </summary>
        public string InformationLevelText { get; set; } = "Information";

        /// <summary>
        /// Whether or not <see cref="LogMessageSeverity.Warning"/> messages will be logged.
        /// <para>Defaults to <see langword="true"/>.</para>
        /// </summary>
        public bool EnableWarningLogSeverity { get; set; } = true;
        /// <summary>
        /// The color to set the console foreground (text) color when logging <see cref="LogMessageSeverity.Warning"/> messages.
        ...
        /// <summary>
        /// The color to set the console background color when logging <see cref="LogMessageSeverity.Warning"/> messages.
        /// <para>Defaults to <see cref="DefaultBackgroundColor"/>.</para>
        /// </summary>
        public ConsoleColor? WarningBackgroundColor { get; set; } = default;
        /// <summary>
        /// The text to use when logging <see cref="LogMessageSeverity.Warning"/> messages.
        /// <para>Defaults to <c>Warning</c>.</para>
        /// </summary>
        public string WarningLevelText { get; set; } = "Warning";

        /// <summary>
        /// Whether or not <see cref="LogMessageSeverity.Error"/> messages will be logged.
        /// <para>Defaults to <see langword="true"/>.</para>
        /// </summary>
        public bool EnableErrorLogSeverity { get; set; } = true;
        /// <summary>
        /// The color to set the console foreground (text) color when logging <see cref="LogMessageSeverity.Error"/> messages.
        /// <para>Defaults to <see cref="ConsoleColor.Yellow"/>.</para>
        /// </summary>
        public ConsoleColor ErrorForegroundColor { get; set; } = ConsoleColor.Yellow;
        /// <summary>
        /// The color to set the console background color when logging <see cref="LogMessageSeverity.Error"/> messages.
        /// <para>Defaults to <see cref="DefaultBackgroundColor"/>.</para>
        /// </summary>
        public ConsoleColor? ErrorBackgroundColor { get; set; } = default;
        /// <summary>
        /// The text to use when logging <see cref="LogMessageSeverity.Error"/> messages.
        /// <para>Defaults to <c>Error</c>.</para>
        /// </summary>
        public string ErrorLevelText { get; set; } = "Error";

        /// <summary>
        /// Whether or not <see cref="LogMessageSeverity.Critical"/> messages will be logged.
        /// <para>Defaults to <see langword="true"/>.</para>
        /// </summary>
        public bool EnableCriticalLogSeverity { get; set; } = true;
        /// <summary>
        /// The color to set the console foreground (text) color when logging <see cref="LogMessageSeverity.Critical"/> messages.
        /// <para>Defaults to <see cref="ConsoleColor.Red"/>.</para>
        /// </summary>
        public ConsoleColor CriticalForegroundColor { get; set; } = ConsoleColor.Red;
        /// <summary>
        /// The color to set the console background color when logging <see cref="LogMessageSeverity.Critical"/> messages.
        /// <para>Defaults to <see cref="DefaultBackgroundColor"/>.</para>
        /// </summary>
        public ConsoleColor? CriticalBackgroundColor { get; set; } = default;
        /// <summary>
        /// The text to use when logging <see cref="LogMessageSeverity.Critical"/> messages.
        ...
        /// <summary>
        /// Whether to log messages in the same color as their respective <see cref="LogMessageSeverity"/>'s color.
        ...
        /// <summary>
        /// The color to set the console background color when a <see cref="LogMessageSeverity"/>'s background color is otherwise not specified.
